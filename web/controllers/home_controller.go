...
func HomeIndex(c *gin.Context){
	...
	post1 := &post{Id: 1, Author: "雷小天", HeadImg: "http://thirdqq.qlogo.cn/g?b=oidb&k=7iaib304zfK77M2ibtukgic1kQ&s=100&t=1585567893",
		Nickname: "雷小天", Name: "提问", Title: "docker+jenkins+github实现golang项目自动部署 #Jenkins", IsAdmin: 0, IsVip:3, CreatTime: 1618328126, CreatDate: "2020-01-19", Reward: 20, Solved: 1, CommentNum: 2}
